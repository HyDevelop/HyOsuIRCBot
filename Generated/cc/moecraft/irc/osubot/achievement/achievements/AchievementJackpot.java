package cc.moecraft.irc.osubot.achievement.achievements.AchievementJackpot;
...
public class AchievementJackpot extends Achievement
{
    ...
    @Override
    public String getTutorial() { return "<br> Get 222,222 (or 6,666,666 etc.) score on any ranked map.<br>"; }
