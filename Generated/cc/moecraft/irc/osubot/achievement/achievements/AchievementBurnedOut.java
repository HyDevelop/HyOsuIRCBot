package cc.moecraft.irc.osubot.achievement.achievements.AchievementBurnedOut;
...
public class AchievementBurnedOut extends Achievement
{
    ...
    @Override
    public String getTutorial() { return "<br> Pass any map with SO mod. Can use other mods in the same play.<br>"; }
