package cc.moecraft.irc.osubot.achievement.achievements.AchievementBlindsight;
...
public class AchievementBlindsight extends Achievement
{
    ...
    @Override
    public String getTutorial() { return "<br> Pass any map with HD mod. Can use other mods in the same play.<br>"; }
