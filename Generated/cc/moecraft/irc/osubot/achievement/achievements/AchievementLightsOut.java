package cc.moecraft.irc.osubot.achievement.achievements.AchievementLightsOut;
...
public class AchievementLightsOut extends Achievement
{
    ...
    @Override
    public String getTutorial() { return "<br> Pass any map with NC+FL mods (double click on DT mod to get NC)."; }
