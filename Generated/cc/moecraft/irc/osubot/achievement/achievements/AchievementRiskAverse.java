package cc.moecraft.irc.osubot.achievement.achievements.AchievementRiskAverse;
...
public class AchievementRiskAverse extends Achievement
{
    ...
    @Override
    public String getTutorial() { return "<br> Pass any map with NF mod. Can use other mods in the same play.<br>"; }
