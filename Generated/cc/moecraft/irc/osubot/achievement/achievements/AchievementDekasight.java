package cc.moecraft.irc.osubot.achievement.achievements.AchievementDekasight;
...
public class AchievementDekasight extends Achievement
{
    ...
    @Override
    public String getTutorial() { return "<br> Full combo a 3+ star map with EZ+HD+FL mods. <a href=\"https://osu.ppy.sh/s/141\">FAIRY FORE - Vivid</a> is only 13 seconds long."; }
