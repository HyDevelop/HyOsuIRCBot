...
public class ModelGenerator {
    ...
    public static void main(String[] args){
        Jboot.setBootArg("jboot.datasource.url", "jdbc:mysql://119.29.222.57:3306/testSql?characterEncoding=utf8&useSSL=true");
        Jboot.setBootArg("jboot.datasource.user", "root");
        Jboot.setBootArg("jboot.datasource.password", "password");
