...
public class UtilSSLSocketFactory extends SSLSocketFactory {
	 ...
	 * the right server. Cannot be combined with {@link #disableDiffieHellman(SSLSocketFactory)
	 ...
	 * socket factory. Cannot be combined with {@link #disableDiffieHellman(SSLSocketFactory)
	 * } since this overwrites the wrapped factory and will throw an exception!
	 *
