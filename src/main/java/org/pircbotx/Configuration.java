...
public class Configuration {
	...
	/**
	 * Use {@link Builder#buildConfiguration() }.
	 *
	 * @param builder
	 * @see Builder#buildConfiguration()
	 */
	...
	public static class Builder {
		 ...
		 * {@link #setNickservNick(String) } in its hostmask will
		...
		/**
		 * @deprecated Use {@link #addServer(String)},
		...
		/**
		 * @deprecated Use {@link #addServer(String, int)},
		 * will be removed in future releases
		 */
		@Deprecated
		 ...
		 * CoreHooks with
		 * {@link ListenerManager#removeListener(Listener) }
		 *
