 ...
 * executors
 * <ul>
 * <li>Pooled (default for {@link #addListener(Listener) }) -
 * Run each event in the provided {@link #getExecutorPool() }. By default uses
 * the unbounded {@link Executors#newCachedThreadPool(ThreadFactory)
 * }
 ...
 * done in a {@link Executors#newSingleThreadExecutor(ThreadFactory)
...
public class SequentialListenerManager extends AbstractListenerManager {
	...
	/**
	 * Alias of {@link #appendListenerPooled(Listener) }
	 *
	 * @param listener
	 */
	@Override
