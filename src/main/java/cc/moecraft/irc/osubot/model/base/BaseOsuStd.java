...
public abstract class BaseOsuStd<M extends BaseOsuStd<M>> extends JbootModel<M> implements IBean {

    public static final String ACTION_ADD = "OsuStd:add";
    public static final String ACTION_DELETE = "OsuStd:delete";
    public static final String ACTION_UPDATE = "OsuStd:update";
