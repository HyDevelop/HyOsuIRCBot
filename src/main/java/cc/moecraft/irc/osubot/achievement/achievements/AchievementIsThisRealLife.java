...
public class AchievementIsThisRealLife extends Achievement
{
    ...
    @Override
    public String getTutorial() { return " Full combo a map with AR11 OD11 HP11 and over 260BPM.   <a href=\"https://osu.ppy.sh/b/20737\">ERIKA - Destination Nowhere</a> [Hard] with HDDTHR unlocks this achievement. "; }
