...
/**
 * 此类由 Hykilpikonna 在 2018/05/132 17:31:36 用 AchievementClassGenerator 生成!
 * Created by Hykilpikonna on 2018/05/132 17:31:36!
 *
...
public class AchievementCleanPlatter extends Achievement
{
    ...
    @Override
    public String getTutorial() { return " Full combo a 3 star map without using EZ/NF/HT mods (don't miss slider ends). <a href=\"https://osu.ppy.sh/b/315\">FAIRY FORE - Vivid</a> [Insane] (taiko) "; }
