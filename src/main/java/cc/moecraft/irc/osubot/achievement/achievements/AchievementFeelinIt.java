...
public class AchievementFeelinIt extends Achievement
{
    ...
    @Override
    public String getTutorial() { return " Your max combo must be the same as maps BPM (or half of it) Full combo <a href=\"https://osu.ppy.sh/b/1267643\" >Harumachi Clover [Kisses' Easy]</a>"; }
