...
public class LanguageFileManager
{
    ...
    public class LanguageFile extends Config
    {
        ...
        public void writeDefaultConfig()
        {
            ...
            addDefault("error_unknown_backend_error", "未知后台错误, 请联系me@hydev.org");
            addDefault("error_unknown_username", "未找到用户: %info_getUsername%, 如果确定该用户存在, 请联系me@hydev.org");
            addDefault("error_unknown_username_2", "未找到用户: %usernameAndMode_getUsername%, 如果确定该用户存在, 请联系me@hydev.org");
