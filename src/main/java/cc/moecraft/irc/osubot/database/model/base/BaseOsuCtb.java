...
public abstract class BaseOsuCtb<M extends BaseOsuCtb<M>> extends JbootModel<M> implements IBean {

    public static final String ACTION_ADD = "OsuCtb:add";
    public static final String ACTION_DELETE = "OsuCtb:delete";
    public static final String ACTION_UPDATE = "OsuCtb:update";
